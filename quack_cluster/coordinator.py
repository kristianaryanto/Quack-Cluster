...
async def execute_query(request: QueryRequest):
    """
    Menerima kueri SQL, mendistribusikannya ke worker, dan menggabungkan hasilnya.
    """
    try:
        ...
        # SOLUSI: Ganti tabel dengan placeholder sederhana terlebih dahulu
        ...
        # SOLUSI: Sekarang ganti placeholder dengan fungsi read_parquet
